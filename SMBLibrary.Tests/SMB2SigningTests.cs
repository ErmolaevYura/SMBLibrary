...
namespace SMBLibrary.Tests
{
    ...
    public class SMB2SigningTests
    {
        ...
        public void TestSMB202SignatureCalculation()
        {
            ...
            byte[] signature = SMB2Cryptography.CalculateSignature(exportedSessionKey, SigningAlgorithm.HMACSHA256, message, 0, message.Length);
        ...
        public void TestSMB300SignatureCalculation()
        {
            ...
            byte[] signingKey = SMB2Cryptography.GenerateSigningKey(exportedSessionKey, SMB2Dialect.SMB302, null);
            ...
            byte[] signature = SMB2Cryptography.CalculateSignature(signingKey, SigningAlgorithm.AESCMAC, message, 0, message.Length);
